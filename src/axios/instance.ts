...
export const devAxiosInstance = axios.create({
  baseURL: import.meta.env.VITE_API_BASE_URL,
  timeout: 10000,
});

export const prodAxiosInstance = axios.create({
...
addInterceptors(devAxiosInstance);
addInterceptors(prodAxiosInstance);
